 ...
 * @since 27/01/2017
 */
public class MissingBindingTypeException extends IllegalBindingActionException {

    public MissingBindingTypeException(String targetType, String key) {
        super("There must be a binding type in " + targetType + " for key " + key + "'");
    }
}
